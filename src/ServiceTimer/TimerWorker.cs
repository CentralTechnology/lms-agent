...
namespace ServiceTimer
{
    ...
    public abstract class TimerWorker : IDisposable
    {
        ...
        private void _doWork(TimerWorkerInfo info)
        {
            ...
            _log?.Info(logmessages.WorkerWorkEnter,
                info.WorkId,
                info.ThreadId,
                entered.ToString("u"));
#endif
            ...
            catch (Exception ex)
            {
                ...
                _log?.Warn(logmessages.WorkerOnWorkException, wex);
            ...
            if (_log != null)
            {
                ...
                _log.Info(logmessages.WorkerWorkExit,
                    info.WorkId,
                    info.ThreadId,
                    exited.ToString("u"));
                ...
                _log.Info(logmessages.WorkerWorkDuration,
                    info.WorkId,
                    info.ThreadId,
                    duration);
            }
...
#if BASELOG
            _log?.Info($"TimerWorkerInfo: {info}");
#endif
        ...
        private void _QueryAndHandleServiceState(TimerWorkerInfo info, out bool doWork, out bool stop)
        {
            ...
            if (state == TimerServiceBase.ServiceState.Running)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    if (_log != null)
                    {
                        _log.Warn(logmessages.WorkerOnContinueException, cex);
                    }
            ...
            else if (state == TimerServiceBase.ServiceState.Pausing)
            {
                ...
                else
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        if (_log != null)
                        {
                            _log.Warn(logmessages.WorkerOnPauseException, pex);
                        }
            ...
            else if (state == TimerServiceBase.ServiceState.Stopping)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    if (_log != null)
                    {
                        _log.Warn(logmessages.WorkerOnStopException, sex);
                    }
            ...
            else if (state == TimerServiceBase.ServiceState.ShuttingDown)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    if (_log != null)
                    {
                        _log.Warn(logmessages.WorkerOnShutdownException, sex);
                    }
        ...
        {
#if BASELOG
            _log?.Info(logmessages.WorkerOnContinue,
                info.WorkId,
                info.ThreadId);
#endif
        }
        ...
        {
#if BASELOG
            _log?.Info(logmessages.WorkerOnPause,
                info.WorkId,
                info.ThreadId);
#endif
        }
        ...
        {
#if BASELOG
            _log?.Info(logmessages.WorkerOnShutdown,
                info.WorkId,
                info.ThreadId);
#endif
        }
        ...
        {
#if BASELOG
            _log?.Info(logmessages.WorkerOnStop,
                info.WorkId,
                info.ThreadId);
#endif
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                Log?.Info($"Base disposed of managed resources occurred in type {GetType().Name}");
#endif
            }
