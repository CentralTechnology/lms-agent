namespace LMS.Core.Veeam.DBManager
{
      ...
      public static class SqlFieldDescriptor
  {
    ...
    public static ISqlFieldDescriptor<Decimal?> DecimalNullable(
      string fieldName)
    {
    ...
    public static ISqlFieldDescriptor<DateTime?> DateTimeNullable(
      string fieldName)
    {
    ...
    public static ISqlFieldDescriptor<string> NVarChar(
      string fieldName,
      int maxSize)
    {
      if (maxSize < 1 || maxSize > 4000)
        throw new ArgumentOutOfRangeException(nameof (maxSize), (object) maxSize, "Unicode string length must be a value from 1 through 4000.");
    ...
    public static ISqlFieldDescriptor<byte[]> VarBinary(string fieldName)
    {
      return (ISqlFieldDescriptor<byte[]>) new SqlReferenceTypeFieldDescriptor<byte[]>(fieldName, SqlDbType.VarBinary);
    }

    public static ISqlFieldDescriptor<byte[]> VarBinary(
      string fieldName,
      int maxSize)
    {
      if (maxSize < 1 || maxSize > 8000)
        throw new ArgumentOutOfRangeException(nameof (maxSize), (object) maxSize, "Binary data length must be a value from 1 through 8000.");
      return (ISqlFieldDescriptor<byte[]>) new SqlExtendableReferenceTypeFieldDescriptor<byte[]>(fieldName, SqlDbType.VarBinary, maxSize);
    }

    public static ISqlFieldDescriptor<object> Variant(string fieldName)
    {
      return (ISqlFieldDescriptor<object>) new SqlReferenceTypeFieldDescriptor<object>(fieldName, SqlDbType.Variant);
    }
    ...
    public static ISqlFieldDescriptor<T?> SmallIntNullableEnum<T>(
      string fieldName)
      where T : struct
    {
      SqlFieldDescriptor.CheckEnumTypeCompatibility<T>(SqlDbType.SmallInt);
